...
class KindEditorWidget extends InputWidget
{
    ...
    public function registerClientScript()
    {
        ...
        if ($themeType != self::THEME_TYPE_DEFAULT) {
            $view->registerCssFile($asset->baseUrl . "/themes/{$themeType}/{$themeType}.css", ['depends' => '\sq\zui\kindeditor\KindEditorAsset']);
        }
        $preJs = '';
...
";
        ...
        $view->registerJsFile($asset->baseUrl . '/lang/' . $this->clientOptions['langType'] . '.js', ['depends' => '\sq\zui\kindeditor\KindEditorAsset']);
        $id = $this->options['id'];
